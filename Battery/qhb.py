    ...
    def read_data(self):
        ...
        try:
            ...
            batt_data = {
                ...
                "batt_type": "1",
                "batt_serialNumber": self.serial_number,
                "batt_firmwareVersion": self.revision,
                ...
                "bat_response": {
                    "batt_error_code": "0" if self.success else "1",
                    "batt_error_message": "No errors" if self.success else self.status,
                }
            }
